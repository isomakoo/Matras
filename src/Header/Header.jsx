      ...
      <div className="header-container">
        ...
        <ul className="header-list">
          <li className="header-listes">
            <Link
              to="/home"
              className={`header-link ${location.pathname === "/home" ? "active" : ""}`}
            >
              {t("home")}
            </Link>
          </li>
          ...
          <li className="header-listes">
            <Link
              to="/product"
              className={`header-link ${location.pathname === "/product" ? "active" : ""}`}
            >
              {t("product")}
            </Link>
          </li>
          ...
          <li className="header-listes">
            <Link
              to="/faq"
              className={`header-link ${location.pathname === "/faq" ? "active" : ""}`}
            >
              {t("faq")}
            </Link>
          </li>
