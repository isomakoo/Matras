      ...
      <div className="contactsection">
        ...
        <div className="contactsection-list">
          ...
          <nav className="contactsection-navbar">
             ...
             <a href="WestMatress1@gmail.com" className="contactsection-link">WestMatress1@gmail.com</a>
             <p className="contactsection-text">
               Murojat uchun Raqamkar:
             </p>
             <a href="tel:+998 95 840 79 79" className="contactsection-link">+998 95 840 79 79</a> <br />
             <a href="tel:+998 78 333 79 79" className="contactsection-link">+998 78 333 79 79</a>
             <p className="contactsection-text">
             Bizning manzil:
             </p>
             <a href="WestMatress1@gmail.com" className="contactsection-link">Yunusobod tumani, Yangi Yunusobod ko‘chasi, 13-kvartira, 45-uy, 14-xonadon</a>
          </nav>
        </div>
      </div>
    </>
